  ...
  <div class="home">
    <section class="home_banner_area">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="banner_content">
                  <h5>This is me testing mastertt</h5>
                  <h2>Travor James</h2>
                  <p>You will begin to realise why this exercise is called the Dickens Pattern (with reference to the ghost showing Scrooge some different futures)</p>
                  <a href="#" class="genric-btn success circle arrow">Discover Now<span class="lnr lnr-arrow-right"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 col-sm-6 brand web">
              <div class="projects_item">
                ...
                <div class="projects_text">
                  <router-link to="/detail-project"><h4>3D Helmet Design</h4></router-link>
                  <p>Client Project</p>
                </div>
              </div>
            </div>
      ...
      <section class="testimonials_area p_120">
        ...
        <div id="user" class="testi_slider owl-carousel">
          <div class="item">
